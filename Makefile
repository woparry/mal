...
IMPLS = ada ada.2 apl awk bash basic c chuck clojure coffee common-lisp cpp crystal cs d \
  dart elisp elixir elm erlang es6 factor fantom forth fsharp go groovy gnu-smalltalk \
